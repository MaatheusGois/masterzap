...
describe('rendering', () => {
  ...
  it('links the quote to the message and cites date and page', () => {
    ...
    expect(md).toContain('](https://MaatheusGois.github.io/masterzap/#/chat/alexandre-de-moraes/msg/39) ⟨15/11/2025 18:22 · laudo p. 109, fig. 108⟩');
    expect(md).toContain('[Ciro](https://MaatheusGois.github.io/masterzap/chat/ciro-soares/)');
  ...
  it('points at the static anchor when told where messages live', () => {
    ...
    expect(linksToMarkdown(text, { ...opts, hrefFor: locate }))
      .toContain('](https://MaatheusGois.github.io/masterzap/chat/alexandre-de-moraes/#msg-39) ⟨');
    expect(linksToMarkdown('{x}[action:search@martha-graeff:presidente bacen]', { resolve, hrefFor: locate }))
      .toContain('](https://MaatheusGois.github.io/masterzap/chat/martha-graeff/2024-12/#msg-35686)');
